// dolphin.test.rtspclient.cpp : Defines the entry point for the console application.
//
...
int _tmain(int argc, char* argv[]) {
	...
	//}
	openURL(*env, "testRtsp", "rtsp://10.82.13.15/1/h264major");
