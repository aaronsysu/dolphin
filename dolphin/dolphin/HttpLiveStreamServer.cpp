...
{
	HttpLiveStreamServer::HttpLiveStreamServer(std::string param)
	...
	HttpLiveStreamServer::~HttpLiveStreamServer()
	{
	}

	void HttpLiveStreamServer::Start()
	{
		av_register_all();
	...
	void HttpLiveStreamServer::Stop()
	{
		dolphin_base::Consumer::Stop();
	}

	void HttpLiveStreamServer::ProcessFrame(dolphin_common::Frame::Ptr frame)
	{
	...
	void HttpLiveStreamServer::WritePlaylist()
	{
